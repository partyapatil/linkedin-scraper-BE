...
export async function scrapeLinkedInProfiles(searchQuery) {
  ...
  try {
    // Block unnecessary resources to speed up scraping [web:2][web:4]
    ...
    // Set additional headers to appear more legitimate [web:6]
    ...
    // Simulate human-like scrolling behavior [web:9]
    await page.evaluate(() => {
